...
export const SEARCH_CAPTION_PRE = "搜索关键词【";
export const SEARCH_CAPTION_MID1 = "】耗时 ";
export const SEARCH_CAPTION_MID2 = " 秒，共计找到 ";
export const SEARCH_CAPTION_SUF = " 条结果";

export const UNKNOWN_PROVINCE = "未知";
...
export const REPRESENTATIVE = "代理人";

export const NO_PROSECUTOR = "无起诉方信息";
export const NO_DEFENDANT = "无应诉方信息";
export const NO_REPRESENTATIVE = "无代理人信息";
